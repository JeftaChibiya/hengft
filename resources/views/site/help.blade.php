...
@section('page_intro')
    <div style="background: linear-gradient(180deg, rgb(38, 69, 137), rgb(38, 76, 137))" class="pb-4">
        ...
        <div class="pt-8 pl-5 sm:pl-16 sm:pt-10 mb-6">
            <p class="text-2xl lg:text-3xl font-bold text-gray-300">
                Help Center
            </p>
        </div>             
    </div>   
        ...
        <div class="w-full sm:w-1/3 mb-2 sm:mb-0 mr-4 px-5 sm:px-0 relative">
            ...
            <ul class="text-gray-600 no-underline text-lg font-light mb-10">
                <li class="mb-5 hover:text-blue-500 hover:underline">
                    <a href="/help/what-is-hengft">What is HengFT?</a>
                </li>
                <li class="mb-5 hover:text-blue-500 hover:underline">
                    <a href="/help/hengft-free-trial">How does your free trial work?</a>                         
                </li>
                <li class="mb-5 hover:text-blue-500 hover:underline">
