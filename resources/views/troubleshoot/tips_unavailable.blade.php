...
@section('page_intro')
    ...
    <div class="pt-3 pl-5 sm:pl-16 sm:pt-10 mb-6">
        ...
        <p class="text-2xl lg:text-3xl font-bold text-gray-700 mb-10">
            Why can I not see any pre-match tips?
        </p>
    </div>    
@stop
...
<div class="container mx-auto px-5 sm:px-24 pb-10 font-light leading-normal">
    ...
    <p class="text-gray-700 font-medium text-xl mb-2">It is off-season, or no matches are occurring within a given time period</p> 
    <div class="w-full sm:w-1/2 mb-10 text-lg text-gray-700">
